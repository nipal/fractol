...
/*   Updated: 2017/04/12 15:30:01 by fjanoty          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	t_buff_file	*get_next(int fd)
{
	t_buff_file	*node;
...
static	t_buff_file	*stack_buff_file(int fd, int *total_size, int *nb_buff)
{
...
static	int	destroy_buff_file_stack(t_buff_file **beg)
{
	t_buff_file	*node;
	t_buff_file	*tmp;
...
static	int		copy_stack_in_str(t_buff_file *beg, int nb_buff, int size, char *str)
{
	t_buff_file	*node;
//	int			i;
	int			diff;
